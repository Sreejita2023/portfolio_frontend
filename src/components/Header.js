...
function Header(props) {
  return (
    <div className="bg-slate-800 left-0 right-0 relative z-10 px-4 flex flex-col items-center pb-10 pt-10">
         ...
         <div className="AgencyProvidesAFu w-[570px] h-[66px] text-center text-white text-opacity-60 text-base font-normal font-['Epilogue'] leading-loose">{props.title}</div>
    </div>
  )
}

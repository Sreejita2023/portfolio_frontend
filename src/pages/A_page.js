  ...
  return (
    <div>
      ...
      <div className=" bg-orange-50 flex flex-col items-center pt-12">
        ...
        />
        <div className="flex flex-col items-start gap-y-4 py-3">
          <div className="GabrielPires text-red-400 text-base font-normal font-['Epilogue'] uppercase leading-loose tracking-[3px]">
            Sreejita Sen
          </div>
          <div className="ProfessionalWebDes w-[570px] text-orange-950 text-[56px] font-extrabold font-['Epilogue'] leading-[64px]">
            Professional Web Designer
          </div>
          <div className="AbilityToPutThems w-[570px] h-[227px] text-orange-950 text-opacity-60 text-base font-normal font-['Epilogue'] leading-loose">
      ...
      <div className=" bg-red-100 relative pt-20">
        ...
        <div className="flex flex-row justify-around ">
          <div className="flex flex-col items-start">
            ...
            <div className="IHelpCompaniesMov text-orange-950 text-2xl font-bold font-['Epilogue'] leading-loose">
              I Help Companies <br />
              Move Faster
            </div>
